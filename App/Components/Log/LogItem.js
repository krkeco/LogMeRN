  ...
  render() {
    let colorModal = (
      <ColorPicker
        ...
        toggle={() => {
          this.setState({ viewColorModal: !this.state.viewColorModal });
        }}
      />
    );
          ...
          {Object.keys(this.props.log.values).map((value, index) => {
            return (
              ...
              >
                <Text>
                  {' '}
                  {value} :: Value: {this.props.log.values[value].value}
                </Text>
      ...
      >
        <View>
          <View style={{ height: 50, flex: 1, flexDirection: 'row' }}>
            ...
            <Text style={{ height: 30, margin: 5, fontSize: 25 }}>
              {this.props.log.label}
            </Text>

            <Text style={{ marginTop: 22 }}>
              log of: {this.props.prettyDate}
            </Text>
          </View>
          <View
            style={{
          ...
          >
            ...
            <View style={{ paddingTop: 20 }}>
              <Button
                color={this.props.log.color}
                onPress={() => {
                  this.props.saveLogData(
                    this.props.prettyDate,
                    this.state.value,
                    this.state.note,
                    this.props.log,
                  );
        ...
        <View style={{ alignItems: 'center' }}>{showDataView}</View>
      </View>
    );
  }
}
